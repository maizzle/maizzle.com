      ...
      <div class="sticky top-0">
        <div class="pt-4 bg-slate-50">
          ...
          >
            ...
            <span class="shadow-sm border rounded text-[11px] py-0.5 px-1 text-slate-500">Ctrl K</span>
          </button>
        </div>
      ...
      <ul class="mb-8 -ml-4">
        ...
        <li>
          <NuxtLink
            ...
            class="flex gap-2 items-center px-4 py-2 text-sm text-slate-500 hover:text-slate-900 group"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 transition-colors text-slate-400 group-hover:text-slate-500">
