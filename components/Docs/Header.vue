        ...
        <div class="w-60 flex items-end gap-4">
          ...
          <div class="relative inline-block text-left text-xs text-slate-600">
            ...
            <div
              ...
              class="origin-top-right absolute z-10 left-0 mt-2 w-[6.5rem] rounded-md shadow-lg bg-white ring-1 ring-black/5 focus:outline-none"
              role="menu"
          ...
          <div class="hidden sm:block max-w-[80ch] w-full mx-auto whitespace-nowrap overflow-auto">
            <p>
              <a
                ...
                target="_blank"
                class="hidden sm:inline-block text-indigo-500 hover:text-indigo-600"
              ><span class="font-medium">Mailviews</span></a>: beautiful, expertly coded HTML email components and templates.
            </p>
          </div>
        </div>
      ...
      <div class="col-span-6 mx-auto flex gap-4 items-end justify-center">
        ...
        <div class="relative hidden sm:inline-block">
          ...
          <div
            ...
            class="origin-top-right absolute left-5 mt-2 w-24 rounded-md shadow-lg bg-white text-sm ring-1 ring-black/5 focus:outline-none"
            role="menu"
            aria-orientation="vertical"
...
const { public: { latestRelease } } = useRuntimeConfig()

const { data: navigation } = await useAsyncData('docs-header-nav', () => {
